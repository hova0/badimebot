...
//         public event EventHandler<MessageEvent> PrivateMessageReceived;
...
//                 if(y.Data.Channel == channel && MessageReceived != null) {
//                     MessageEvent me = new MessageEvent() { From = getshortnick(y.Data.From), Message = y.Data.Message};
//                     MessageReceived?.Invoke(this, me);
//                 }
//             };
//             c.OnQueryMessage  += (x,y) => { 
//                 MessageEvent me = new MessageEvent() { From = getshortnick(y.Data.From), Message = y.Data.Message};
//                 PrivateMessageReceived?.Invoke(this, me);
//             };
...
//             catch (Exception e)
//             {
//                 PrintToConsoleWithColor("Error: " + e.Message, ConsoleColor.Red);
//                 return;
//             }
...
//             _ircclient.RfcPart(channel, Meebey.SmartIrc4net.Priority.High);
//             _ircclient.RfcQuit(Meebey.SmartIrc4net.Priority.High);
//             _ircclient.Disconnect();
//         }


//         private string getshortnick(string fullnick) {
//             return fullnick.Substring(0, fullnick.IndexOf("!"));
//         }
...
//         {
//             _ircclient.SendMessage(Meebey.SmartIrc4net.SendType.Message, nick, msg);
//         }
